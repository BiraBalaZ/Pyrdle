...
print()
print(''' ____   __     __ \033[32m _____  \033[m  ______    __      ____ ''')
print('''|  _ \  \ \   / / \033[32m|  _  \ \033[m |      \  |  |    |  __|''')
print('''| |_) |  \ \./ /  \033[32m| |_)  |\033[m |  .-.  | |  |    | |_  ''')
print('''|  __/    \   /   \033[32m|     / \033[m |  | |  | |  |    |  _| ''')
print('''| |        | |    \033[32m| |\  \.\033[m |  '-'  | |  `--. | |__ ''')
print('''|_|        |_|    \033[32m|_| `._|\033[m |______/  |_____| |____|''')
print()
